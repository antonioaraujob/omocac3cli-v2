...
\begin{tabularx}{\textwidth}{|XXXXXXXXXX|m{1cm}|m{1cm}|X}
...
BEGIN { 
	FS=","; gen1="";gen2="";gen3="";gen4="";gen5="";gen6="";gen7="";gen8="";gen9="";gen10=""; 
}
...
{ 
	...
	print gen1" & "gen2" & "gen3" & "gen4" & "gen5" & "gen6" & "gen7" & "gen8" & "gen9" & "gen10 " & " $41" & "$42 "\134\134" ;
...
%\begin{tabularx}{\textwidth}{XXXXXXXXXXXrr}
\begin{tabularx}{\textwidth}{|XXXXXXXXXX|m{1cm}|m{1cm}|}
