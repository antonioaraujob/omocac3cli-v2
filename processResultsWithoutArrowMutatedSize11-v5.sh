...
#
#
# version 5: corrige error cuando la descubierta de un gen = 0
...
{ 
        ...
        # linea comentada para eliminar la columna de FONC
        #print gen1" & "gen2" & "gen3" & "gen4" & "gen5" & "gen6" & "gen7" & "gen8" & "gen9" & "gen10" & "gen11 " & " $56" & "$57 "&" $58"\134\134" ;
        print gen1" & "gen2" & "gen3" & "gen4" & "gen5" & "gen6" & "gen7" & "gen8" & "gen9" & "gen10" & "gen11 " & " $56" & "$57 "\134\134" ;
        if (NR =="1")
        {
            print "\\hline";
            print "\\hline";
