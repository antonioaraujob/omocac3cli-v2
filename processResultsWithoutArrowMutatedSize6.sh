...
\begin{tabularx}{\textwidth}{|XXXXXX|m{1cm}|m{1cm}|X}
...
BEGIN { 
	FS=","; gen1="";gen2="";gen3="";gen4="";gen5="";gen6="";
}
...
{ 
	...
	print gen1" & "gen2" & "gen3" & "gen4" & "gen5" & "gen6 " & " $25" & "$26 "\134\134" ;
...
%\begin{tabularx}{\textwidth}{XXXXXXXXXXXrr}
\begin{tabularx}{\textwidth}{|XXXXXX|m{1cm}|m{1cm}|}
