...
\begin{tabularx}{\textwidth}{|XXXXXXXX|m{1cm}|m{1cm}|X}
...
BEGIN { 
	FS=","; gen1="";gen2="";gen3="";gen4="";gen5="";gen6="";gen7="";gen8="";
}
...
{ 
	...
	print gen1" & "gen2" & "gen3" & "gen4" & "gen5" & "gen6" & "gen7" & "gen8 " & " $33" & "$34 "\134\134" ;
...
%\begin{tabularx}{\textwidth}{XXXXXXXXXXXrr}
\begin{tabularx}{\textwidth}{|XXXXXXXX|m{1cm}|m{1cm}|}
