...
\begin{tabularx}{\textwidth}{|XXXXXXXXX|m{1cm}|m{1cm}|X}
...
{ 
	...
	print gen1" & "gen2" & "gen3" & "gen4" & "gen5" & "gen6" & "gen7" & "gen8" & "gen9" & " $37" & "$38 "\134\134" ;
...
%\begin{tabularx}{\textwidth}{XXXXXXXXXXXrr}
\begin{tabularx}{\textwidth}{|XXXXXXXXX|m{1cm}|m{1cm}|}
