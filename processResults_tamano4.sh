...
\begin{tabularx}{\textwidth}{|XXXX|m{0.5cm}|m{0.5cm}|m{0.3cm}|}
...
{ 
	...
	print gen1" & "gen2" & "gen3" & "gen4" & "$17" & "$18 "& " $19 "\134\134" ;
...
%\begin{tabular}{lrrrrrrrrrrrr}
\hline
%\multicolumn{4}{l}{Ch$<\$min,max\$>\rightarrow\$AP} & \$FO_1\$ & \$FO_2\$ \\""\\
\multicolumn{4}{|l|}{Ch\newline\$<\$min,max\$>\rightarrow\$AP} & \$FO_1\$\newline(\#AP) & \$FO_2\$\newline(ms) & nscan \\""\\
\hline
" >> salida.tex
